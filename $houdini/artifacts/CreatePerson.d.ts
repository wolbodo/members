import type { auth_person_role_update_column } from "$houdini/graphql/enums";
import type { auth_person_role_constraint } from "$houdini/graphql/enums";
import type { auth_person_update_column } from "$houdini/graphql/enums";
import type { auth_person_constraint } from "$houdini/graphql/enums";
...
export type CreatePerson$optimistic = {
    readonly person?: {
        readonly id?: number;
        readonly name?: string;
    } | null;
